...
Este gráfico de  bigote (boxplot) muestra la interacción entre los niveles de riego (irrigado y sequía) y los genotipos (G01 a G15) en relación con el peso seco del brote (variable de respuesta).
La línea dentro de la caja indica la mediana, los bordes de la caja muestran el rango entre el primer y tercer cuartil, y los bigotes se extienden hasta los valores máximo y mínimo, excluyendo los puntos atípicos (outliers).Los puntos azules individuales permite ver la variabilidad entre las plantas dentro de cada genotipo bajo condiciones de riego

G01 y G02, presentan valores de peso seco más similares entre los tratamientos de riego y sequía, lo que sugiere que son más tolerantes a la escasez de agua.
...
La interacción "riego:geno" también resultó ser estadísticamente significativa (p-valor < 0.05). Esto quiere decir que el efecto del riego sobre la variable de respuesta dependió del genotipo de la planta. 
